...
import newstudiowork.newtest.UI.views.pulltorefresh.ILoadingLayout.State;
import newstudiowork.newtest.UI.views.slidexlibrary.ActionSlideExpandableListView;

/**
 * 这个类实现了ActionSlideExpandableListView下拉刷新，上加载更多和滑到底部自动加载 
 */
public class PullToRefreshExListView extends PullToRefreshBase<ActionSlideExpandableListView> implements OnScrollListener {
     ...
     */
    public PullToRefreshExListView(Context context, AttributeSet attrs, int defStyle) {
